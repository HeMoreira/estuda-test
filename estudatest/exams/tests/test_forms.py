...
class QuestionTypeFormTests(TestCase):
    def test_valid_choice(self):
        self.assertTrue(QuestionTypeForm(data={'question_type': Question.Types.FLASHCARD}).is_valid())

    def test_invalid_choice_rejected(self):
        self.assertFalse(QuestionTypeForm(data={'question_type': 'nao_existe'}).is_valid())

    def test_missing_choice_rejected(self):
        self.assertFalse(QuestionTypeForm(data={}).is_valid())